...
public class Bounce extends Animation {
    ...
    protected void initAnimator() {
        ...
        Ball b2 = new Ball(d, 4, 4, -5, 0, 40, 20, Color.BLUE);
        Ball b3 = new Ball(d, 6, 5, -3, 0, 40, 20, Color.GREEN);
        Ball b4 = new Ball(d, 2, 4, 2, 0, 40, 15, Color.RED);
        Ball b5 = new Ball(d, 3, 4, -5, 0, 40, 20, Color.BLUE);
        Ball b6 = new Ball(d, 5, 3, -3, 0, 40, 20, Color.GREEN);
